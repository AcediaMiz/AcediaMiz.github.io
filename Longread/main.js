  ...
  completedHtmlOnCondition: [
    {
      ...
      html: "<h4>Олд</h4><p class='ans'> Что ж, судя по всему, вы только начинаете знакомиться с новомодными молодежными словечками. Вам есть куда расти. Но не расстраивайтесь, скоро большая часть этих слов забудется и станет кринжем.</p>",
    },
    {
      expression: "{correctAnswers} <= 6",
      html: "<h4>Нормис</h4><p class='ans'> Это основа, это, так сказать, база. Вы владеете сленгом на среднем уровне. Можете поддержать смол-ток с зумером, но поговорить с поколением “альфа” уже будет труднее. Если хотите углубить свои знания, попробуйте полистать Тик-ток часов эдак 6.</p>",
    },
    {
      expression: "{correctAnswers} >=7",
      html: "<h4>Имба</h4> <p class='ans'> Вы не НПС, вы настоящий гагчад и сигма. Чиллите на плотных вайбах и скамите мамонтов. Ваши знания настолько велики, что вам явно есть что добавить в этот лонгрид. Продолжайте в том же духе, но не переусердствуйте, а то уже кринж.</p>",
    },
  ],
  logoPosition: "right",
  pages: [
